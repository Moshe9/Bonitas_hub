...
if($currentTab == 3){
    ...
    if($result != $userId){
        ...
        $sql = "UPDATE tbl_members_contacts as mc, tbl_advisors as a SET mc.m_cell = '$cell',mc.m_telh = '$hometel',mc.m_telw = '$worktel',mc.mtax = '$taxnumber',mc.m_comm_method ='$comm_method',
