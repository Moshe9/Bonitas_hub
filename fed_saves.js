function db_saves()
{
    ...
    if((depsconst == 'no' && currentTab == 5) || (depsconst == 'yes' && currentTab == 6))
    {
        ...
        while(counter <= counter2)
        {
            ...
            if(namesurname || medschemename || memshipnumber || joindate || enddate )
            {
                if(!namesurname)
                {
                    namesurname = '';
                ...
                {
                    value= [namesurname, medschemename, memshipnumber, joindate, enddate, ''];
                    pmArray.push(value);
                }
            }
            console.log(pmArray);
    ...
    if((depsconst == 'no' && currentTab == 6) || (depsconst == 'yes' && currentTab == 7))
    {
        ...
        while(counter11 <= counter1){
            ...
            medication =  document.getElementById('medicalquestion1'+counter11+'-medication').value;
            ...
            console.log("Counter 11 - medication"+medication)
            ...
            {
                value = [fullname, illness, treated, firsttreatmentdate, lasttreatmentdate, gpfullname, medicalquestion,medication];
                mqArray1.push(value);
            }
...
console.log(mqArray1);
        while(counter21 <= counter2){
            ...
            if(!document.getElementById('medicalquestion2'+counter21+'-medication').value)
            {
                medication = '';
            }else{
                var medication =  document.getElementById('medicalquestion2'+counter21+'-medication').value;
            }
        ...
        while(counter31 <= counter3){
            ...
            if(!document.getElementById('medicalquestion3'+counter31+'-medication').value)
            {
                medication = '';
            }else{
                var medication =  document.getElementById('medicalquestion3'+counter31+'-medication').value;
            }
        ...
        while(counter41 <= counter4){
            ...
            if(!document.getElementById('medicalquestion4'+counter41+'-medication').value)
            {
                medication = '';
            }else{
                var medication =  document.getElementById('medicalquestion4'+counter41+'-medication').value;
            }
