            ...
            <div class="col s12 m6 l4 z-depth-4 card-panel border-radius-6 login-card bg-opacity-8">
                ...
                <div class="row">
                    <div class="input-field col s12">
                        ...
                        <p style="text-align: center;">Please create new password below</p>
                    </div>
                    @if(Session::has('fail'))
                ...
                <div class="row margin">
                    ...
                    <label for="email" class="center-align">Enter your Email</label>
                    </div>
                </div>
                <div class="row margin">
                    <div class="input-field col s12">
                ...
                <div class="row margin">
                    ...
                    <label for="cpassword" class="center-align">Confirm new password</label>
                    </div>
                </div>
                <div class="row">
                    <div class="input-field col s12">
                        <button type="submit" class="btn waves-effect waves-light btn-bonitas"><i class="fa fa-check-square-o"></i> Change Password
                        </button>
                    </div>
                </div>
                <div class="row">
                    <div class="input-field col s6 m6 l6">
                    <p class="margin right-align medium-small text-links"><a href="{{URL::to('/')}}">Login</a>
                    </p>
                    </div>
                </div>
                </form>
