...
<link rel="stylesheet" href="{{asset('frontend/css/bonitas.css')}}">
    ...
    <div class="navbar navbar-fixed ">
        <nav>
            <div class="nav-wrapper">
                <a href="{{url('/hub-home')}}" class="brand-logo"><img src="{{asset('frontend/images/bonitas_assets/logo.png')}}" alt="Bonitas Logo" class="logo"></a>
