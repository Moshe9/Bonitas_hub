...
//Checks to see if required documents are uploaded
if($submitsatus == 'ERROR')
{
    $status = -1;
...
}else if($submitsatus == 'OK')
{
    ...
    echo "There's an error on the system, please try again later";
}
...
<tr><td style="width: 22%;border-right: solid 2px #3b3838;padding: 5px 10px;"><p>Do you acknowledge that if the member is over the age of 45 or under the age of 45 with the five conditions</p></td><td style="padding: 0 10px;">'. $_POST['brokerconsent1'] .'</td></tr>
<tr><td style="width: 22%;border-right: solid 2px #3b3838;padding: 5px 10px;"><p>You agree that you have all previous schemes certificate of membership for each member that will be added. You acknowledge and agree that if these certificate of memberships are not attached on submission that the application will be rejected<p></td><td style="padding: 0 10px;">'. $_POST['brokerconsent2'] .'</td></tr>
<tr><td style="width: 22%;border-right: solid 2px #3b3838;padding: 5px 10px;"><p>You agree that you have that if there is a third party bank account being used for contributions that you have a letter of consent from the account holder in question. You acknowledge and agree that if this letter of consent is not attached on submission that the application will be rejected<p></td><td style="padding: 0 10px;">'. $_POST['brokerconsent3'] .'</td></tr>
<tr><td style="width: 22%;border-right: solid 2px #3b3838;padding: 5px 10px;"></td><td style="padding: 0 10px;"></td></tr>
<tr><td style="width: 22%;border-right: solid 2px #3b3838;padding: 5px 10px;"></td><td style="padding: 0 10px;"></td></tr>
...
if($submitsatus == 'OK'){ //|| $submitsatus == 'ERROR'){ this is for when you are testing with negative responses
    ...
    if($_FILES['com2upload']['name']){
    $file2 = file_get_contents('uploads/'.$filesname2);
    ...
    if($_FILES['com3upload']['name']){
    $file3 = file_get_contents('uploads/'.$filesname3);
    ...
    if($_FILES['com4upload']['name']){
    $file4 = file_get_contents('uploads/'.$filesname4);
    ...
    if($_FILES['com5upload']['name']){
    $file5 = file_get_contents('uploads/'.$filesname5);
    ...
    if($_FILES['consentupload']['name']){
    $file6 = file_get_contents('uploads/'.$filesname6);
...
// echo "files size for empty : ".$_FILES['com4upload']['size'];
    ...
    $uploads .= $collectionend;
        ...
        $uploadurl = "https://services.webapi.heliosits.com:443/fhir/v3/applications/BON/".$membershipnumber."/documents?dependantNumber=00&queryId=".$submitqueryid."";
