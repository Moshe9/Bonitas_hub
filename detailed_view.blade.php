...
<div class="col sm-12 "style="height:82%">
    ...
    <div class="col sm-8 mb-3"  style="width:90%;">
        ...
        <div class="col sm-8">
            ...
            @if($apps->status == 1)
            <a href="{{url('/pdf-copy/'.$apps->user_id)}}" class="btn btn-bonitas-view btn-individual">
                VIEW PDF
            </a>
            ...
            @else
            <a href="{{url('/pdf-copy/'.$apps->user_id)}}" class="btn btn-bonitas-view disabled btn-individual">
                VIEW PDF
            </a>
            <a href="#" class="btn btn-bonitas-view disabled btn-individual">
                EMAIL COPY TO MEMBER
            </a>
            <a href="{{url('/fed-edit-application/'.$apps->user_id)}}" class="btn btn-bonitas-view btn-position btn-individual">
                EDIT APPLICATION
            </a>
            @endif
        </div>
