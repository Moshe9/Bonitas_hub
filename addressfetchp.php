...
// $suburbchosen2 = 'FLORIDA HILLS';
$suburbchosen3 = str_replace(' ', '%20', $suburbchosen2);
$curl = curl_init();
curl_setopt_array($curl, array(
  CURLOPT_PORT => "443",
  CURLOPT_URL => "https://services.webapi.heliosits.com:443/services/online/data/suburbs/".$suburbchosen3."",
  ...
  if ( ! empty($array)) {
    ...
    foreach($array['town'] as $listedsubs){
      ...
      foreach($listedsubs as $key=>$value){
        ...
        if(($key === "suburb" && $value === $suburbchosen2) && $listedsubs['postalType'] === 'P'){
