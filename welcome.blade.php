      ...
      <div class="container">
        ...
        <div id="login-page" class="row">
            <div class="col s12 m6 l4 z-depth-4 card-panel border-radius-6 login-card bg-opacity-8">
                ...
                <div class="row">
                    <div class="input-field col s12">
                        <button type="submit" class="btn waves-effect waves-light btn-bonitas"><i class="fa fa-sign-in"></i> Login
                        </button>
                    </div>
                </div>
                <div class="row">
                    <div class="input-field col s6 m6 l6">
                    <p class=" medium-small text-links"><a href="{{URL::to('/forgot-pass')}}">Forgot password ?</a>
                    </p>
                    </div>
                </div>
                </form>
