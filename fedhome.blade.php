...
<div id="main">
    ...
    <div class="col sm-8">
        ...
        <a href="{{url('/fed-individual')}}" class="btn btn-bonitas btn-individual">
            Fedhealth
        </a>
            ...
            <table class="striped ">
                ...
                <?php
                    $submitted_applications = DB::table('fed_tbl_advisors')
                                        ...
                                        ->orderBy('fed_tbl_advisors.updated_at','desc')
                                        ->orderBy('fed_tbl_advisors.user_id','DESC')
                                        ->get();
        ...
        <div class="col sm-8 mb-3">
            <table class="striped">
                ...
                <tr>
                    ...
                    <td>
                        <form action="{{ url('/fed-delete-additional/'.$info->user_id) }}" method="post">
                            @csrf
                            <a href="{{ url('/fed-delete-additional/'.$info->user_id) }}" class="show-confirm action"><i class="fa fa-trash fa-lg"></i> DEL</a>
                        </form>
                    </td>
                </tr>
                @endforeach
        ...
        <div class="col sm-8 mb-3">
            <table class="striped">
                ...
                <tr>
                    ...
                    <td > <a href="{{('/fed-edit-application/'.$pend->user_id)}}" class="action"><i class="fa fa-pencil fa-lg"> </i> Edit</a></td>
                    <td>
                        <form action="{{ url('fed-delete-pending/'.$pend->user_id) }}" method="POST">
                            @csrf
                            <a href="{{ ('fed-delete-pending/'.$pend->user_id) }}"class="show-confirm action"><i class="fa fa-trash fa-lg"></i> DEL</a>
                        </form>
                    </td>
                </tr>
                @endforeach
