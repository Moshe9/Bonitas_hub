...
if ($conn->connect_error) {
  die("Connection failed: " . $conn->connect_error);
    ...
    $deps = mysqli_query($conn, "SELECT * FROM tbl_dependents WHERE user_id = $userId");
    if(!empty($deps))
    {
    ...
    $prevmeds = mysqli_query($conn, "SELECT * FROM tbl_medical_scheme WHERE user_id = $userId");
    if(!empty($prevmeds))
    {
    ...
    //GP Noms Build
    $gpnoms = mysqli_query($conn, "SELECT * FROM tbl_gpnominations WHERE user_id = $userId");
    if(!empty($gpnoms))
    {
    ...
    $medicals = mysqli_query($conn,"SELECT * FROM tbl_medical_questions WHERE user_id = $userId");
    if(!empty($medicals))
    {
...
$get_status = mysqli_query($conn,"SELECT status FROM tbl_advisors WHERE user_id = $userId");
...
if($result[0] != '1')
{
	...
	{
	    $status = -1;
	    $sql = "UPDATE tbl_advisors SET status = '$status', errormessage = '$errormessage',errorcode = '$errorcode' WHERE user_id = '$userId'";
	...
	}else if($submitsatus == 'OK')
	{
	    ...
	    $status = 1;
	    $sql = "UPDATE tbl_advisors SET status = '$status', reference_id
        ...
        $status = -1;
        $sql = "UPDATE tbl_advisors SET status = '$status', errormessage = 'Error reaching Nexus Submission', errorcode = 'F1001' WHERE user_id = '$userId'";
	    if(mysqli_query($conn, $sql)){
...
$message .=  '<tr style="background: #3b3838;color: #ffffff;"><td colspan="2" style="height: 40px;margin: 0;padding: 0 10px;"><h3 style="margin: 0;color: #ffffff;">Submission Details</h3></td></tr>
  ...
  $message .=  '<tr style="background: #3b3838;color: #ffffff;"><td colspan="2" style="height: 40px;margin: 0;padding: 0 10px;"><h3 style="margin: 0;color: #ffffff;">Submission Details</h3></td></tr>
  <tr><td style="width: 22%;border-right: solid 2px #3b3838;padding: 5px 10px;">Error Message</td><td style="padding: 0 10px;color: #9d0000;">There was an error reaching nexus</td></tr>';
$message .=  '<tr><td style="width: 22%;border-right: solid 2px #3b3838;padding: 5px 10px;"></td><td style="padding: 0 10px;"></td></tr>
  <tr><td style="width: 22%;border-right: solid 2px #3b3838;padding: 5px 10px;"></td><td style="padding: 0 10px;"></td></tr>';
}
...
//DOMPDF Ends=====================================================
//Additional Uploads
$prevmedcheck = mysqli_query($conn,"SELECT * FROM tbl_medical_scheme WHERE 'user_id' = $userId");
